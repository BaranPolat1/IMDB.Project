...
namespace IMDB.DAL.Migrations
{
    ...
    [Migration("20200526202217_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IMDB.Entites.Entity.AppUser", b =>
                {
            ...
            modelBuilder.Entity("IMDB.Entites.Entity.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("IMDB.Entites.Entity.Movie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("IMDB.Entites.Entity.Movie", b =>
                {
                    b.HasOne("IMDB.Entites.Entity.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("IMDB.Entites.Entity.AppUser", null)
                        .WithMany()
